...
namespace VetClinic.WebApi.Controllers
{
    ...
    public class EmailController : Controller
    {
        ...
        public IActionResult Send(EmailViewModel model)
        {
            ...
            string body = "User wants to request a procedure with id of " + model.Procedure + " for their pet " 
                + model.Pet + ". An OrderProcedure with id: " + model.OrderProcedure + " was created for their request.";
